...
def go(args):
    ...
    logger.info("create a wandb.Artifact")
    artifact = wandb.Artifact(args.output_artifact, type="model_export",
                              description="Random Forest Model Export", metadata=rf_config)
    artifact.add_dir("random_forest_dir")
    logger.info("log the artifact to the run")
...
def get_inference_pipeline(rf_config, max_tfidf_features):
    ...
    # Create a pipeline compose of 2 steps: preprocessor and random forest
    sk_pipe = Pipeline(
        steps=[
